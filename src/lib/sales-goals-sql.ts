/**
 * sales_goals is keyed by client_code + product category.
 * Roll up to employee/branch/team via clients.담당자.
 */
...
export { GOAL_CATEGORY_TYPE } from './sales-goals-categories';
