        ...
        return (
          <div key={month} className="space-y-4">
            <div className="flex items-center gap-2 px-1">
              <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100">{month.split('-')[1]}월 매출 실적</span>
                ...
                <table className="w-full text-sm text-center border-separate border-spacing-0">
                  <thead>
                    <tr className="bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 font-bold">
                      <th className="px-4 py-4 border-r border-b border-zinc-200 dark:border-zinc-800 w-24 sticky left-0 z-10 bg-zinc-50 dark:bg-zinc-900">사업소</th>
                      ...
                      <th className="px-4 py-4 border-r border-b border-zinc-200 dark:border-zinc-800">판매용량 (L)</th>
                  ...
                  <tfoot className="bg-blue-50/30 dark:bg-blue-900/10 font-bold">
                    <tr>
                      ...
                      <td className="px-4 py-4 border-r border-zinc-200 dark:border-zinc-800 text-right">{formatNumber(monthTotal.mobileSalesWeight)}</td>
                      <td className="px-4 py-4 text-right">{formatNumber(monthTotal.flagshipSalesWeight)}</td>
                    </tr>
