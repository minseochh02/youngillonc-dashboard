                                ...
                                {yearDetails.map((cat) => (
                                  <Fragment key={`${yearRow.year}_${cat.category}`}>
                                    ...
                                    <tr className="border-b border-zinc-100/70 dark:border-zinc-800/40 bg-zinc-50/70 dark:bg-zinc-800/30">
                                      <td className="py-1.5 px-3 whitespace-nowrap"></td>
                                      <td className="py-1.5 px-3 font-semibold text-zinc-700 dark:text-zinc-200 whitespace-nowrap">B2B</td>
                                      <td className="py-1.5 px-3 text-right font-mono whitespace-nowrap">{formatNumber(cat.b2b_total?.sales_weight ?? 0)}</td>
                                      <td className="py-1.5 px-3 text-right font-mono whitespace-nowrap">{formatNumber(cat.b2b_total?.last_year_sales_weight ?? 0)}</td>
                                      <td className="py-1.5 px-3 text-right whitespace-nowrap">-</td>
                                      <td className={`py-1.5 px-3 text-right font-medium whitespace-nowrap ${(cat.b2b_total?.yoy_growth_rate ?? 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
