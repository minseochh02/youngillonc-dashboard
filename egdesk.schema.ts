...
export const TABLES = {
  ...
  west_inventory_adjustments: {
    name: 'west_inventory_adjustments',
    displayName: '서부재고조정현황',
    columns: ['id', '일자', '품목코드', '창고코드', '장부수량', '실사수량', '조정수량', '적요'],
    columnCount: 8,
    rowCount: 0,
  },
  west_production_material_consumption: {
    name: 'west_production_material_consumption',
    displayName: '서부생산입고/소모현황',
    columns: ['id', '일자', '일자번호', '생산품목코드', '출고창고코드', '입고창고코드', '생산품목명', '소모품목코드', '소모품목명', '생산수량', '표준소모수량', '실제소모수량', '생산품목단가', '소모품목단가', '차이', '금액'],
    columnCount: 16,
    rowCount: 0,
  },
  east_inventory_transfers: {
  ...
  east_production_material_consumption: {
