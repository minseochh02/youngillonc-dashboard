 ...
 * Generated at: 2026-03-13T01:29:16.006Z
 *
...
export const EGDESK_CONFIG = {
  ...
  apiKey: 'b97e386a-d1e4-49c3-8fbf-94ba49c5f679',
} as const;
...
export const TABLES = {
  table1: {
    ...
    rowCount: 86,
    columnCount: 26,
    columns: ['id', 'source_message_ids', 'extracted_at', 'employee_name', 'activity_date', 'chat_room', 'activity_type', 'activity_summary', 'activity_details', 'customer_name', 'location', 'products_mentioned', 'task_status', 'task_priority', 'time_spent_hours', 'planned_completion_date', 'related_project', 'related_department', 'mentioned_employees', 'requires_followup', 'is_blocker', 'sentiment', 'next_action', 'next_action_date', 'confidence_score', 'extraction_model']
  } as TableDefinition,
  table2: {
...
export const TABLE_NAMES = {
  table1: 'employee_activity_log',
  table2: 'employee_master',
  table3: 'daily_standup_log',
  table4: 'inventory_transfers',
  table5: 'internal_uses',
  table6: 'purchase_orders',
  table7: 'deposits',
  table8: 'promissory_notes',
  table9: 'product_mapping',
  table10: 'sales',
  table11: 'ledger',
  table12: 'pending_purchases',
  table13: 'pending_sales',
  table14: 'inventory',
  table15: 'purchases'
} as const;
