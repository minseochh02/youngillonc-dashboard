 ...
 * Generated at: 2026-03-05T09:58:48.447Z
 *
...
export const EGDESK_CONFIG = {
  ...
  apiKey: 'aa5ee840-e04f-4d8c-bf8e-5e78f539236b',
} as const;
...
export const TABLES = {
  ...
  table2: {
    ...
    rowCount: 12080,
    columnCount: 17,
    columns: ['id', '일자', '일자_no', '적요', '계정코드', '계정명', '거래처명', '거래처코드', '부서명', '담당자코드', '차변금액', '대변금액', '잔액', '회사명', '기간', '계정코드_메타', '계정명_메타']
  } as TableDefinition,
  table3: {
  ...
  table7: {
    ...
    displayName: '창고이동현황',
    description: 'Imported from user_database_export_2026-03-02.xlsx - Sheet: 창고이동현황(inventory_migration)',
    rowCount: 42,
    columnCount: 12,
  ...
  table8: {
    name: 'internal_uses',
    displayName: '자가사용현황',
    description: 'Imported from user_database_export_2026-03-02.xlsx - Sheet: 자가사용현황(self_usage)',
    rowCount: 45,
    columnCount: 10,
  ...
  table9: {
    ...
    displayName: '발주서현황',
    description: 'Imported from user_database_export_2026-03-02.xlsx - Sheet: 발주서현황(orders)',
    rowCount: 819,
    columnCount: 14,
  ...
  table10: {
    name: 'deposits',
    displayName: '입금보고서집계',
    description: 'Imported from user_database_export_2026-03-02.xlsx - Sheet: 입금보고서집계(deposits)',
    rowCount: 674,
    columnCount: 16,
  ...
  table11: {
    ...
    description: 'Imported from user_database_export_2026-03-02.xlsx - Sheet: 받을어음거래내역(promissory_notes)',
    rowCount: 83,
    columnCount: 12,
...
export const TABLE_NAMES = {
  table1: 'sales',
  table2: 'ledger',
  table3: 'pending_purchases',
  table4: 'pending_sales',
  table5: 'inventory',
  table6: 'purchases',
