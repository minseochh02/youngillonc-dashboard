/**
 * Delete November 2025 rows from ledger table
 */
...
async function main() {
  console.log('Deleting November 2025 rows from ledger...\n');

  // Find all November 2025 rows
  const findQuery = `SELECT id FROM ledger WHERE 일자 >= '2025-11-01' AND 일자 <= '2025-11-30'`;
  ...
  // Verify deletion
  const verifyQuery = `SELECT COUNT(*) as count FROM ledger WHERE 일자 >= '2025-11-01' AND 일자 <= '2025-11-30'`;
