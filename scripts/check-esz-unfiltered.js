...
async function main() {
  console.log(`🔍 Checking Auto Flagship Liters in esz018r__6_ (WITHOUT warehouse filter)...`);
  ...
  console.log('\n📊 Auto Flagship Snapshot (esz018r__6_ - No Warehouse Filter):');
  console.log('Total Quantity (ea):', result.rows[0]?.total_qty);
  console.log('Total Liters (L):', result.rows[0]?.total_weight);
}
